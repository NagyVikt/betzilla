...
export default function LoginPage() {
  ...
  const baseInputClasses =
    "appearance-none transition-colors duration-300 relative block w-full px-3 py-3 border placeholder-gray-500 rounded-md focus:outline-none text-sm";
  const emailInputClass = `${baseInputClasses} ${
    email
      ? "bg-[#36352c] border-[#8a8021] text-[#e8e6d3]"
      : "bg-[#1c1c1c] border-gray-700 text-white focus:border-gray-500"
  }`;
  const passwordInputClass = `${baseInputClasses} ${
    password
      ? "bg-[#36352c] border-[#8a8021] text-[#e8e6d3]"
      : "bg-[#1c1c1c] border-gray-700 text-white focus:border-gray-500"
  }`;
