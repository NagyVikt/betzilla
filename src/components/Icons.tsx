...
export const HomeIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cx("w-5 h-5", className)} {...props} >
    <path d="M3 9.5L12 3l9 6.5V20a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9.5z" />
    <polyline points="9 22 9 12 15 12 15 22" />
  </svg>
);
export const CookbookIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cx("w-5 h-5", className)} {...props} >
    <path d="M21 4H8a2 2 0 0 0-2 2v16l8-4 8 4V6a2 2 0 0 0-2-2z" />
  </svg>
);
...
export const HeartIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cx("w-5 h-5", className)} {...props} >
    <path d="M20.8 4.6c-1-1-2.4-1-3.4 0l-1 .9-1-.9c-1-1-2.4-1-3.4 0-1 1-1 2.6 0 3.6l4.4 4.3 4.4-4.3c1-1 1-2.6 0-3.6z" />
  </svg>
);



// 1) SearchIcon: a simple magnifying‐glass shape
...
// 2) UserIcon: a silhouette of a person
export const UserIcon = ({ className, ...props }: IconProps) => (
  ...
  >
    ...
    {/* Shoulders/body */}
    <path d="M5.5 20c0-3.5 2.8-6.5 6.5-6.5s6.5 3 6.5 6.5" />
  </svg>
);